...
export const conversation: FunctionInterpolation<Theme> = (theme) => css`
  display: flex;
  border-left: 0;
  border-top: 0;
  box-shadow: none;
...
export const conversations: FunctionInterpolation<Theme> = (theme) => css`
  border-radius: 1px;
  height: 100%;
  margin: 0;
  padding: 0;
...
export const conversationName: FunctionInterpolation<Theme> = (theme) => css`
  flex-grow: 1;
  font-weight: ${theme.typography.fontWeightMedium};
`;

export const conversationPreview: FunctionInterpolation<Theme> = (theme) => css`
  display: block;
...
export const conversationTime: FunctionInterpolation<Theme> = (theme) => css`
  color: ${theme.colors.blueygrey};
`;
...
}): FunctionInterpolation<Theme> => () => css`
  position: absolute;
  bottom: 0;
...
export const dialogMessage = ({
  ...
  isCurrentUser: boolean;
}): FunctionInterpolation<Theme> => (theme) =>
  css`
    position: relative;
...
export const dialogTime = ({
  ...
  isCurrentUser: boolean;
}): FunctionInterpolation<Theme> => (theme) => css`
  display: block;
  font-size: 11px;
  font-weight: ${theme.typography.fontWeightMedium};
