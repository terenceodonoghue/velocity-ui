...
export const chart: FunctionInterpolation<Theme> = (theme) => css`
  .recharts-area-dot {
...
export const metricLabel: FunctionInterpolation<Theme> = (theme) => css`
  margin-top: 1px;
  color: ${theme.colors.blueygrey};
  line-height: 1.47;
`;

export const metricValue: FunctionInterpolation<Theme> = (theme) => css`
  font-size: 320%;
