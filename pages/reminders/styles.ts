...
export const kanbanColumnHeading = ({
  length,
}: Measurable): FunctionInterpolation<Theme> => (theme) => css`
  margin: 7px 0;
  color: #b0bac9;
  font-size: 80%;
...
export const kanbanTicket: FunctionInterpolation<Theme> = (theme) => css`
  display: inline-block;
  border: none;
  border-radius: 5px;
  margin: 0;
...
export const kanbanTicketText: FunctionInterpolation<Theme> = (theme) => css`
  display: flex;
