...
describe('Reminders', () => {
  ...
  describe('move', () => {
    it('moves ticket to a different column', () => {
      ...
      const result = move({ droppableId: 0, index: 0 }, { droppableId: 1, index: 1 }, columns);
  ...
  describe('reorder', () => {
    it('moves ticket within same column', () => {
      const columns = Array.from(kanban.data);
      const result = reorder({ droppableId: 0, index: 0 }, { droppableId: 0, index: 1 }, columns);
  ...
  describe('onDragEnd', () => {
    ...
    it('triggers callback when source matches destination', () => {
      ...
      onDragEnd(
        { source: { droppableId: 0, index: 0 }, destination: { droppableId: 0, index: 1 } },
        columns,
        mockCallback,
      );
