...
export const passengerFieldLabel: FunctionInterpolation<Theme> = (theme) => css`
  color: #b0bac9;
  margin-bottom: 10px;
  font-size: 12px;
...
export const passengerInteractions: FunctionInterpolation<Theme> = (
  theme,
) => css`
  margin: 0;
...
export const passengerName: FunctionInterpolation<Theme> = (theme) => css`
  margin: 0 0 2px;
  font-size: 15px;
  font-weight: ${theme.typography.fontWeightMedium};
  line-height: 1.47;
...
export const paymentLogo = ({
  selected,
}: Selectable): FunctionInterpolation<Theme> => (theme) => css`
  display: flex;
  align-items: center;
...
export const tripAddress: FunctionInterpolation<Theme> = (theme) => css`
  flex: 1;
...
export const tripMetric: FunctionInterpolation<Theme> = (theme) => css`
  flex: 1;
  padding: 30px 24px 0;
